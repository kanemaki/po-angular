...
export interface PoPageDynamicEditActions {
   ...
   * @description
   *
   * Ação que é executada antes da ação `cancel` e que serve para realização de validações prévias.
   *
   * Tanto o método como a API devem retornar um objeto com a definição de `PoPageDynamicEditBeforeCancel`.
   *
